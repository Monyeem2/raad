...
//
//     final getSurveydataModel = getSurveydataModelFromJson(jsonString);

import 'dart:convert';

List<GetSurveydataModel> getSurveydataModelFromJson(String str) => List<GetSurveydataModel>.from(json.decode(str).map((x) => GetSurveydataModel.fromJson(x)));

String getSurveydataModelToJson(List<GetSurveydataModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetSurveydataModel {
  GetSurveydataModel({
  ...
  factory GetSurveydataModel.fromJson(Map<String, dynamic> json) => GetSurveydataModel(
